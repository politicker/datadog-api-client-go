...
func (o *SearchServiceLevelObjective) GetCreator() Creator {
...
// and a boolean to check if the value has been set.
func (o *SearchServiceLevelObjective) GetCreatorOk() (*Creator, bool) {
	if o == nil || o.Creator == nil {
		return nil, false
	}
...
func (o *SearchServiceLevelObjective) SetCreator(v Creator) {
	o.Creator = &v
}
...
func (o *SearchServiceLevelObjective) GetMonitorTags() []string {
...
// and a boolean to check if the value has been set.
func (o *SearchServiceLevelObjective) GetMonitorTagsOk() (*[]string, bool) {
	if o == nil || o.MonitorTags == nil {
		return nil, false
	}
...
func (o *SearchServiceLevelObjective) HasMonitorTags() bool {
	if o != nil && o.MonitorTags != nil {
		return true
	}
...
func (o *SearchServiceLevelObjective) SetMonitorTags(v []string) {
	o.MonitorTags = v
}
...
func (o *SearchServiceLevelObjective) GetQuery() ServiceLevelObjectiveQuery {
...
// and a boolean to check if the value has been set.
func (o *SearchServiceLevelObjective) GetQueryOk() (*ServiceLevelObjectiveQuery, bool) {
	if o == nil || o.Query == nil {
		return nil, false
	}
	return o.Query, true
...
func (o *SearchServiceLevelObjective) SetQuery(v ServiceLevelObjectiveQuery) {
	o.Query = &v
}
